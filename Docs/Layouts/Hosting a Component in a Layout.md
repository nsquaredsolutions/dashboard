...
[Building a layout](./Building%20a%20Layout)
and 
[Building a Component](../Components/Building%20a%20Component)
...
Your component should implement `IComponent` and describe where it should appear on the screen. This is done in a new class in this layout project that references the actual SimpleComponent [built in this tutorial](../Components/Building%20a%20Component).
